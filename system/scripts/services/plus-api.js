   ...
   return {
             ...
             get: function(syncKey, id) {
                ...
                if(!_.isNaN(theId)){
                    ...
                    var updatedUrl = syncKey + "/" + theId + "?callback=JSON_CALLBACK&secret_key="+secretKey;
                    return serviceDataPullFn($http, $q, collectionUrl + updatedUrl, syncKey + "_" + theId, syncKey);  
                }else{
                    var params = id;
